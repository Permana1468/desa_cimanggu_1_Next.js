        ...
        <LandingThemeProvider initialIsNightMode={initialIsNightMode}>
            <SmoothScroll>
                ...
                <section id="profil" className="scroll-mt-32">
                    <ScrollReveal>
                        <div className="text-center mb-10 sm:mb-16">
                            <div className="inline-flex items-center gap-2 text-yellow-400 font-extrabold tracking-[0.2em] sm:tracking-[0.25em] uppercase text-[10px] sm:text-xs mb-2.5 sm:mb-3">
                                <Globe size={16} />
                        ...
                        <div className="bg-slate-900/60 backdrop-blur-2xl border border-white/10 rounded-3xl sm:rounded-[2.5rem] p-5 sm:p-8 md:p-12 shadow-[0_0_50px_rgba(6,182,212,0.15)] flex flex-col lg:flex-row gap-8 sm:gap-12 items-center relative overflow-hidden">
                            ...
                            <div className="w-full lg:w-2/5 aspect-video lg:aspect-square bg-slate-950 rounded-2xl sm:rounded-3xl overflow-hidden border border-cyan-500/30 relative group shadow-2xl">
                                ...
                                <div className="absolute inset-x-0 bottom-0 p-4 sm:p-6 bg-slate-950/80 backdrop-blur-md border-t border-white/10">
                                    <div className="flex items-center gap-2 text-yellow-400 font-bold text-[11px] sm:text-xs mb-1">
                                        <Sparkles size={14} /> PUSAT PELAYANAN UTAMA
                                    </div>
                                    <h4 className="text-xl sm:text-2xl font-extrabold text-white">Kantor Kepala Desa</h4>
                                    <p className="text-slate-400 text-[11px] sm:text-xs mt-0.5">Cibungbulang, Kabupaten Bogor</p>
                                </div>
                            ...
                            {/* Profile Details */}
                            <div className="w-full lg:w-3/5 text-slate-300 space-y-4 sm:space-y-6">
                                <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-200 to-slate-400">
                                    {siteData.about_title}
                                </h3>
                                <p className="leading-relaxed text-slate-300 text-sm sm:text-base md:text-lg font-light whitespace-pre-wrap border-l-2 border-cyan-500/40 pl-3.5 sm:pl-4 py-1">
                                    {siteData.about_text}
                                </p>
                                ...
                                <div className="pt-2 sm:pt-4 flex items-center gap-6">
                                    <Link 
                                        href="/profil" 
                                        className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3.5 rounded-full bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-400 hover:to-amber-400 text-slate-950 font-black text-xs uppercase tracking-wider transition-all shadow-[0_0_20px_rgba(245,158,11,0.4)]"
                                    >
                ...
                <section id="peta-interaktif" className="scroll-mt-32">
                    <ScrollReveal>
                        <div className="text-center mb-10 sm:mb-16">
                            <div className="inline-flex items-center gap-2 text-cyan-400 font-extrabold tracking-[0.2em] sm:tracking-[0.25em] uppercase text-[10px] sm:text-xs mb-2.5 sm:mb-3">
                                <Compass size={16} />
                        ...
                        <div className="bg-slate-900/80 border border-cyan-500/30 rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(6,182,212,0.2)] flex flex-col md:flex-row min-h-[480px] md:min-h-[520px] relative backdrop-blur-2xl">
                            {/* Left Control Panel */}
                            <div className="w-full md:w-1/3 bg-slate-950/90 p-5 sm:p-6 md:p-8 border-b md:border-b-0 md:border-r border-white/10 flex flex-col justify-between gap-6 z-10">
                                <div className="space-y-4 sm:space-y-6">
                                    <div className="flex items-center justify-between border-b border-white/10 pb-3 sm:pb-4">
                                        <span className="text-[11px] sm:text-xs font-black uppercase tracking-widest text-cyan-400 flex items-center gap-2">
                                            <Radio size={15} className="animate-pulse" /> WILAYAH DUSUN
                                        </span>
                                        <span className="text-[9px] sm:text-[10px] font-mono bg-cyan-500/10 text-cyan-300 border border-cyan-500/30 px-2 py-0.5 rounded-full">
                                            LAT: -6.5892°
                                        </span>
                                    </div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-slate-900 border border-cyan-500/30 rounded-2xl py-3 pl-11 pr-4 text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:border-cyan-400 focus:shadow-[0_0_15px_rgba(6,182,212,0.3)] transition-all"
                                        />
                                        <Search className="absolute left-3.5 top-3.5 text-cyan-400" size={16} />
                                    </div>

                                    <div className="space-y-2.5 sm:space-y-3 custom-scrollbar max-h-[180px] sm:max-h-[220px] overflow-y-auto pr-1">
                                ...
                                <Link
                                    href="/dashboard/maps"
                                    className="w-full py-3.5 bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-black text-xs uppercase tracking-wider rounded-2xl text-center transition-all shadow-[0_0_20px_rgba(6,182,212,0.4)] flex items-center justify-center gap-2"
                                >
                            ...
                            <div className="w-full md:w-2/3 bg-slate-950 relative group overflow-hidden flex items-center justify-center min-h-[280px] sm:min-h-[350px]">
                                <Image
                                ...
                                <div className="absolute w-[450px] sm:w-[600px] h-[450px] sm:h-[600px] rounded-full border border-cyan-500/20 animate-radar-sweep pointer-events-none flex items-center justify-center">
                                    <div className="w-full h-0.5 bg-gradient-to-r from-cyan-400 via-transparent to-transparent"></div>
                                </div>

                                {/* Concentric Radar Rings */}
                                <div className="absolute w-56 sm:w-72 h-56 sm:h-72 rounded-full border border-cyan-500/20 pointer-events-none"></div>
                                <div className="absolute w-32 sm:w-40 h-32 sm:h-40 rounded-full border border-cyan-500/30 pointer-events-none"></div>
                                ...
                                <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 bg-slate-950/80 backdrop-blur-md border border-cyan-500/40 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-[10px] sm:text-[11px] font-mono text-cyan-300 flex items-center gap-2">
                ...
                <section id="lembaga" className="scroll-mt-32">
                    <ScrollReveal>
                        <div className="text-center mb-10 sm:mb-16">
                            <div className="inline-flex items-center gap-2 text-blue-400 font-extrabold tracking-[0.2em] sm:tracking-[0.25em] uppercase text-[10px] sm:text-xs mb-2.5 sm:mb-3">
                                <ShieldCheck size={16} />
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 sm:gap-6">
                            {lembagaRes?.map((lembaga: any) => (
                                <div 
                                    key={lembaga.id} 
                                    className="bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6 text-center hover:border-cyan-500/40 hover:bg-slate-800/80 transition-all duration-300 group hover:-translate-y-2 shadow-xl hover:shadow-[0_0_25px_rgba(6,182,212,0.2)] flex flex-col items-center justify-center"
                                >
                                    <div className="w-12 sm:w-16 h-12 sm:h-16 bg-cyan-500/15 border border-cyan-500/30 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 group-hover:bg-cyan-500/25 transition-all shadow-[0_0_15px_rgba(6,182,212,0.3)] shrink-0">
                                        <ShieldCheck size={26} className="text-cyan-400 sm:w-8 sm:h-8" />
                                    </div>
                                    <span className="text-[11px] sm:text-xs font-extrabold text-white uppercase tracking-wider leading-tight block">
                                        {lembaga.name}
                                    </span>
                                </div>
                            ))}
                ...
                {/* Footer Section */}
                <footer className="pt-12 sm:pt-20 border-t border-cyan-500/20 text-slate-400">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
                        <div className="col-span-1 sm:col-span-2 space-y-4 sm:space-y-6">
                            <div className="flex items-center gap-3">
                                <Image src={siteData.logo || "/images/logo-bogor.png"} alt="Logo" width={38} height={38} className="drop-shadow-[0_0_12px_rgba(250,204,21,0.6)]" />
                                <span className="text-xl sm:text-2xl font-black text-white tracking-wider uppercase">{siteData.title}</span>
                            </div>
                        ...
                        <div>
                            <h4 className="text-white font-extrabold mb-4 sm:mb-6 uppercase tracking-widest text-[11px] sm:text-xs border-b border-white/10 pb-2">Tautan Cepat</h4>
                            <ul className="space-y-2.5 sm:space-y-3.5 text-xs sm:text-sm font-medium">
                        ...
                        <div>
                            <h4 className="text-white font-extrabold mb-4 sm:mb-6 uppercase tracking-widest text-[11px] sm:text-xs border-b border-white/10 pb-2">Kontak Layanan</h4>
                            <ul className="space-y-2.5 sm:space-y-3.5 text-xs sm:text-sm font-medium">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 py-6 sm:py-8 border-t border-white/5 text-[10px] sm:text-[11px] uppercase font-bold tracking-[0.2em] text-center sm:text-left">
